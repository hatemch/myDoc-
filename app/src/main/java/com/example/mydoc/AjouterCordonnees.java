...
class AjouterCordonnee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.ajouter_cordonnees );
        ...
        buttonRetour.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( AjouterCordonnee.this,EspacePatient.class );
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty( patientid )) {
                   ...
                   /* databaseReference.push().setValue( editTextNom.getText().toString() );
                    ...
                    Toast.makeText( AjouterCordonnee.this, "Data inserted ...", Toast.LENGTH_LONG ).show();
                }
                editTextNom.setText( "" );
